...
| ADR-015 | URL scheme | Accepted | Canonical metadata uses `opensource.simtabi.com/products/sange` + `/documentation/sange`; `sange.sh` is the marketing redirect; repo at `github.com/simtabi/sange`. |
