...
| ADR-015 | URL scheme | Accepted | Canonical metadata uses `opensource.simtabi.com/products/sange` + `/documentation/sange`; `sange.sh` is the marketing redirect; repo at `github.com/simsange/sange` (Simtabi LLC owns the `simsange` GitHub org dedicated to the Sange ecosystem; `simsange/documentation` will host the docs site). Updated 2026-05-16. |
